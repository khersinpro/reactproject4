...
const MainX992 = () => {
  ...
  const [x99MarkTwo, setX99MarkTwo] = useState({name: "XX99 MK II", price: 2999, device: "$", img : "image-xx99-mark-two-headphones.jpg"})
  const {addToCart} = useContext(CartContext)
  const {name, price, device, img} = x99MarkTwo

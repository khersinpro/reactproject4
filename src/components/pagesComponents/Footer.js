  ...
  return (
      <footer>
          <div className='footerBox'>
            <div className='footerBox__nav'>
                <div className='footerBox__nav--logo'>
            ...
            <div className='footerBox__text'>
                <div className='footerBox__text--textBox'>
                    ...
                    <p className='footerCopy'>Copyright 2021. All Rights Reserved</p>
                </div>
            </div>
